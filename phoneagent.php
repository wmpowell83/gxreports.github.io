...
<html>
    ...
    <body>
       ...
       <form action="" method="post">
        <?php
        $sql = "select Month, TeamLead, Agent, avg(AverageWrap), avg(MissedPct), avg(AnswerRate) from PhoneStats where $column like '%$search%' Group by Agent order by TeamLead ASC"; 
